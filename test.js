  ...
  let ConTent = {
    ...
    十年後山本武: {
      card:
        "推薦 : 兇獸來襲、防禦優勢\r\n建議 : 4件套-兇獸來襲,\r\n2件套-爆擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 攻擊加成\r\n6號位 : \r\n爆擊67-75% - 爆擊傷害加成\r\n爆擊無67-75% - 爆擊加成",
      position:
        "主要輸出，戒指建議全滿\r\n較為多變化的角色，高破招情形下魔盒第一支有奇效\r\n推薦星數 : PVE-S , PVP-S",
    },
    列威亞坦: {
      card:
        "推薦 : 左右手之爭、死氣的訓練、絕地的死鬥\r\n建議 : 4件套-死氣的訓練,\r\n2件套-爆擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 攻擊加成\r\n6號位 : \r\n爆擊67-75% - 爆擊傷害加成\r\n爆擊無67-75% - 爆擊加成",
      position:
        "輔助輸出，戒指建議全滿\r\n基本上不太建議訓練的角色\r\n推薦星數 : PVE-A , PVP-B",
    },
    魯斯里亞: {
      card:
        "推薦 : 兇獸來襲、暗中較量\r\n建議 : 4件套-兇獸來襲,\r\n2件套-攻擊加成\r\n2號位 : 破招\r\n4號位 : 命中\r\n6號位 : 爆擊傷害加成",
      position:
        "輔助輸出，戒指建議全滿\r\nSR中少數在PVP同時佔有高爆發又有高破招好斷招的角色，可利用火焰裝置來達成百爆的效果\r\n推薦星數 : PVE-S , PVP-S",
    },
    六道骸: {
      card:
        "推薦 : 精準打擊、暗中較量\r\n建議 : 4件套-暗中較量,\r\n2件套-攻擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 命中\r\n6號位 : 爆擊傷害加成",
    ...
    幻騎士: {
      card:
        "推薦 : 暗中較量、二十年後的雷擊\r\n建議 : 4件套-二十年後的雷擊,\r\n2件套-攻擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 命中\r\n6號位 : 爆擊傷害加成",
      position:
        "主要輸出，戒指基本二技滿\r\n輔助卡配置雷擊命中需要較高可利用火焰裝置達成百爆效果，如無法建議配置暗中較量，不過此角色是利用分身促成的短期爆發，續航力相對較差(重點是長的醜)\r\n推薦星數 : PVE-A , PVP-S",
    },
    Y: {
      card:
        "推薦 : 孤傲的戰士、繼承者的覺悟\r\n建議 : 4件套-孤傲的戰士,\r\n2件套-攻擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 攻擊加成\r\n6號位 : \r\n爆擊67-75% - 爆擊傷害加成\r\n爆擊無67-75% - 爆擊加成",
      position:
        "輔助輸出，戒指建議全滿\r\n因戒指技能及天賦效果較適合長時間的技能消耗，如想有驚人的傷害還是必須以繼承者為主，不建議訓練的角色\r\n推薦星數 : PVE-A , PVP-B",
    },
    藍波: {
      card:
        "推薦 : 精準打擊、絕地的死鬥、守護的誓約\r\n建議 : 4件套-精準打擊,\r\n2件套-爆擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 攻擊加成\r\n6號位 : \r\n爆擊67-75% - 爆擊傷害加成\r\n爆擊無67-75% - 爆擊加成",
    ...
    十年後一平: {
      card:
        "推薦 : 炎壓的爆發、精銳部隊的作風、左右手之爭\r\n建議 : 4件套-炎壓的爆發,\r\n2件套-防禦加成\r\n2號位 : 防禦加成\r\n4號位 : 防禦加成\r\n6號位 : 防禦加成",
      position:
        "輔助，戒指建議全滿\r\n神級輔助，與巴吉爾、了平為輔助三角洲，基本上帶著上場噴發出來的小吃能解決大多數的問題\r\n推薦星數 : PVE-A , PVP-A",
    },
    拉爾米爾奇: {
      card:
        "推薦 : 二十年後的雷擊、守護的誓約\r\n建議 : 4件套-守護的誓約,\r\n2件套-生命\r\n2號位 : 破招\r\n4號位 : 生命加成\r\n6號位 : 生命加成",
      position:
        "輔助，戒指可練可不練\r\n基本上毫無用處，但是在魔盒需要雲屬性的狀況下，技能的效果能發揮很大的功效\r\n推薦星數 : PVE-B , PVP-A",
    },
    獄寺隼人: {
      card:
        "推薦 : 繼承者的覺悟\r\n建議 : 4件套-繼承者的覺悟,\r\n2件套-爆擊加成\r\n2號位 : 攻擊加成\r\n4號位 : 攻擊加成\r\n6號位 : \r\n爆擊67-75% - 爆擊傷害加成\r\n爆擊無67-75% - 爆擊加成",
    ...
    山本武: {
      card:
        "推薦 : 封印之力、防禦優勢、精準打擊\r\n建議 : 4件套-防禦優勢,\r\n2件套-防禦加成\r\n2號位 : 防禦加成\r\n4號位 : 防禦加成\r\n6號位 : 防禦加成",
      position:
        "輔助輸出，戒指可練可不練\r\n基本上不太建議訓練的角色，較屬於在PVP可抓人的定位\r\n推薦星數 : PVE-B , PVP-A",
    },
    十年後碧洋琪: {
      card:
        "推薦 : 左右手之爭、繼承者的覺悟、死氣的訓練\r\n建議 : 4件套-繼承者的覺悟,\r\n2件套-爆擊加成\r\n2號位 : 防禦加成\r\n4號位 : 攻擊加成\r\n6號位 : \r\n爆擊67-75% - 爆擊傷害加成\r\n爆擊無67-75% - 爆擊加成",
      position:
        "輔助輸出，戒指建議全滿\r\n基本上不太建議訓練的角色\r\n推薦星數 : PVE-A , PVP-B",
    },
    未來獄寺隼人: {
